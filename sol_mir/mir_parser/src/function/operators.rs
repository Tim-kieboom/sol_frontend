...
use ast_model::{SolType, TypeId, operators::BinaryOperatorKind};
use mir_model as mir;
use sol_utils::{TypeModifier, fault::Fault, sol_names::PrimitiveTypes, span::Span};
...
impl<'a> FunctionLowerer<'a> {
    ...
    pub(super) fn lower_checked_binary_op(
        ...
        let tuple_ty = self
            .declares
            .intern_type(SolType::TupleKind(ast::TupleKind::Tuple(
    ...
    pub(super) fn lower_checked_div(
        ...
        let SolType::Primitive(prim) = &operand_ty else {
