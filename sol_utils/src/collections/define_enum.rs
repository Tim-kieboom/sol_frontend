...
/// assert_eq!(Names::STRING_VALUES, &["tim", "sol"]);
///
/// const MY_NAME_STR: &str = Names::MyName.as_str(); // const-time
/// assert_eq!(MY_NAME_STR, "tim");
///
/// let best_language = Names::from_str("sol").ok(); // Runtime only
...
/// ## Without precedence
/// ```
/// use sol_utils::sol_names::Symbol;
/// use sol_utils::define_symbols;
///
/// define_symbols! {
