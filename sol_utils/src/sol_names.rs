...
define_str_enum!(
    /// Symbol kinds representing all possible symbols/tokens in the Sol language.
    ///
...
define_str_enum!(
    /// Internal primitive types available in the Sol language.
    ///
...
define_symbols!(
    /// Binary and unary operators available in the Sol language.
    ///
