use ast_model::{
    ...
    InnerFunctionSignature, SolType, StatementId, StatementKind, Struct, Trait, UseBlock,
    VarPattern, Variable, declare_store::DeclareStore, scope::ScopeTypeEntryKind,
};
use ast_parser::fault::AstErrorKind;
use sol_utils::{FunctionId, sol_error_internal, span::Span};
...
impl<'a> NameResolver<'a> {
    ...
    fn check_impl_conformance(&mut self, impl_block: &ImplBlock, span: Span) {
        ...
        let Some(SolType::Stub(stub)) = impl_trait else {
